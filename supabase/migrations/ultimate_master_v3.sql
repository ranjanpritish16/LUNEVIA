-- ==========================================
-- ULTIMATE MASTER DATABASE SETUP SCRIPT (V3)
-- ==========================================
...
-- Bookings (Using exact column names from BookingFlow.tsx)
...
ALTER TABLE public.bookings ADD COLUMN IF NOT EXISTS date text; -- Using text for 'YYYY-MM-DD'
